...
function material_blog_scripts() {
	wp_enqueue_style( 'material-blog-style', get_template_directory_uri() . '/css/materialblog.min.css', null, '0.1.0' );

	wp_enqueue_script( 'jquery' );
	wp_enqueue_script( 'material-blog-navigation', get_template_directory_uri() . '/js/materialblog.min.js', array( 'jquery' ), '0.1.0', true );

	wp_enqueue_script( 'material-blog-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '0.1.0', true );
